...
1. **Byt nyckeln i respektive tjänst** (Vapi, Vonage, Supabase m.fl.) – skapa ny / rotera, inaktivera eller radera gammal.
...
5. **Om du bytte VAPI:** Kolla att **Vapi** fortfarande har rätt API-nyckel i dashboarden.
